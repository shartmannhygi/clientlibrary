...
class GetCaptureStatusTest extends AbstractRequestTest
{
    /**
    ...
    public function testGetCaptureStatusValidationSuccess()
    {
    ...
    public function testGetCaptureStatusValidationOrderID()
    {
        $request = new GetCaptureStatus($this->config);
        ...
        $this->assertValidationReturned(
            'Upg\\Library\\Request\\GetCaptureStatus',
            'orderID',
            'orderID is required',
            $data,
