...
class CustomValidationRequest implements RequestInterface
{

    const CUSTOM_TEST_1 = 1;
    const CUSTOM_TEST_2 = 2;
    const CUSTOM_TEST_3 = 3;
    ...
    public function customValidation()
    {
        ...
        return array($className => array('custom' => array('Test Message')));
    }
}